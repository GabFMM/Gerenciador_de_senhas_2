...
import com.gabfmm.gerenciador_de_senhas.dto.DeleteUserDTO;
import com.gabfmm.gerenciador_de_senhas.dto.UserUpdateDTO;
import com.gabfmm.gerenciador_de_senhas.dto.UserUpdateInfoDTO;
...
public class ConfigurationController extends NavigableController{
    ...
    public void onYesButtonClicked(ActionEvent e){
        ...
        try{
            ...
            showInfo("Usuário atualizado", content.toString());
