...
public class MenuController extends NavigableController {
    ...
    public void setRightPanel(Parent parent){
    ...
    public void onButtonContasClicked(ActionEvent event){
        AccountTabPaneController accountTabPaneController = new AccountTabPaneController(this);
    }

    public void onButtonGeradordeSenhasClicked(ActionEvent event){
        updateStackPane(
                "/com/gabfmm/gerenciador_de_senhas/view/menu/passwordGenerator.fxml",
    ...
    public void onButtonConfiguracoesClicked(ActionEvent event){
        updateStackPane(
                "/com/gabfmm/gerenciador_de_senhas/view/menu/configuration.fxml",
